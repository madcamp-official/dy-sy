...
- Enemy damage-to-zero, death, HP bar, AI, collision, and animation validation
- `ABP_Goblin` warning cleanup
- Wave Manager behavior
- Boss implementation and its two attack patterns
- L_Test navigation/NavMesh decisions

Do not begin or modify teammate-owned enemy work without explicit coordination.
Do not add a manual restart button or duplicate the completed Automatic Restart on Player Death flow.
